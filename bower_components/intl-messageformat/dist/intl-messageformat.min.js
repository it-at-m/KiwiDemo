(function () {
  ...
  function a(a) {
    ...
    for (b = 0, c = f.length; c > b; b += 1) if (d = f[b]) for (e in d) h.call(d, e) && (a[e] = d[e]);
  ...
  var m = function () {
    ...
    function c(a) {
      ...
      function i() {
        var b, c, d, e, f, g;
        if (b = Va, c = [], d = Va, e = w(), e !== E ? (f = B(), f !== E ? (g = w(), g !== E ? (e = [e, f, g], d = e) : (Va = d, d = I)) : (Va = d, d = I)) : (Va = d, d = I), d !== E) for (; d !== E;) c.push(d), d = Va, e = w(), e !== E ? (f = B(), f !== E ? (g = w(), g !== E ? (e = [e, f, g], d = e) : (Va = d, d = I)) : (Va = d, d = I)) : (Va = d, d = I);else c = I;
      ...
      function k() {
        ...
        if (b = z(), b === E) {
          if (b = Va, c = [], L.test(a.charAt(Va)) ? (e = a.charAt(Va), Va++) : (e = E, 0 === _a && d(M)), e !== E) for (; e !== E;) c.push(e), L.test(a.charAt(Va)) ? (e = a.charAt(Va), Va++) : (e = E, 0 === _a && d(M));else c = I;
        ...
        if (b = Va, a.substr(Va, 6) === ga ? (c = ga, Va += 6) : (c = E, 0 === _a && d(ha)), c !== E) {
          if (e = w(), e !== E) {
            if (44 === a.charCodeAt(Va) ? (f = Q, Va++) : (f = E, 0 === _a && d(R)), f !== E) {
              if (g = w(), g !== E) {
                if (h = [], i = s(), i !== E) for (; i !== E;) h.push(i), i = s();else h = I;
      ...
      function u() {
        ...
        if (a = Va, b = t(), b === E && (b = P), b !== E) {
          if (c = w(), c !== E) {
            if (d = [], e = s(), e !== E) for (; e !== E;) d.push(e), e = s();else d = I;
      ...
      function v() {
        var b, c;
        if (_a++, b = [], ra.test(a.charAt(Va)) ? (c = a.charAt(Va), Va++) : (c = E, 0 === _a && d(sa)), c !== E) for (; c !== E;) b.push(c), ra.test(a.charAt(Va)) ? (c = a.charAt(Va), Va++) : (c = E, 0 === _a && d(sa));else b = I;
      ...
      function B() {
        var a, b, c;
        if (a = Va, b = [], c = A(), c !== E) for (; c !== E;) b.push(c), c = A();else b = I;
      ...
      var C,
        ...
        for (b = 0, d = a.length; d > b; b += 1) for (e = a[b], c = 0, f = e.length; f > c; c += 1) g += e[c];
  ...
  j(g, "formats", {
    ...
    for (c = 0, d = a.length; d > c; c += 1) if (e = a[c], "string" != typeof e) {
    ...
    for (b = 0, c = a.length; c > b; b += 1) for (d = a[b].toLowerCase().split("-"); d.length;) {
...
}).call(this); //# sourceMappingURL=intl-messageformat.min.js.map