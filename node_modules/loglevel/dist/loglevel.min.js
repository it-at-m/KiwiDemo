...
!function (a, b) {
  ...
  function g(a, b, c) {
    ...
    a && (l += ":" + a), j.name = a, j.levels = {
      ...
      if (h = b, !1 !== c && e(b), d.call(j, b, a), typeof console === i && b < j.levels.SILENT) return "No console available for logging";
  ...
  var h = function () {},
      i = "undefined",
      j = typeof window !== i && /Trident\/|MSIE /.test(window.navigator.userAgent),
